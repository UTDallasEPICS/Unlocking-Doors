...
Editor: can edit, add, and delete contacts (gets below permissions as well); has access to every page except "Add User"
...
MANAGE TAGS page allows editors/admin to manage tags just in case the user decides to change his/her mind on what each contact should be labeled as with a tag. Also, admins/editors are able to delete tags (either temporarily (incase Unlocking Doors changes their minds in the future) or permanently).

RECOVER CONTACT page allows editors/admin to be able to recover contacts, if they have been soft-deleted. 
